...
- Preparing for entry-level Software Engineering and Backend Engineering roles
- Building backend-oriented portfolio projects with APIs, databases, and AI integration
...
**Interests:** Backend Engineering, Database Systems, AI Integration, Systems Programming
...
- Implemented a Unix-style shell in C with command parsing, built-in commands, fork/exec process creation, and wait-based synchronization
- Added a custom system call to xv6 by connecting the user-space interface, syscall dispatcher, and kernel implementation
- Source code is not publicly shared due to course academic integrity policies
